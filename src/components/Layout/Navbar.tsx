...
import { Bot, Home, ShoppingBag, User, MessageCircle, LogOut, Coins, Settings } from 'lucide-react';

interface NavbarProps {
  currentPage: string;
  onPageChange: (page: 'dashboard' | 'marketplace' | 'profile' | 'messages' | 'admin') => void;
}
